...
[![](../static/nfrs-considered-harmful-tweet.png "I'll make this short: Defining Non-Functional Requirements (NFRs) is
        dangerous. That's the tweet.")](https://twitter.com/hemul/status/1365359887996379136)
...
I\'ve noticed that if you call something \'non-functional\' it immediately becomes deprioritised, a tier two requirement. What people hear is *"this would be nice to have but we don\'t think anyone important actually cares much about it."*
...
(Originally [here](http://web.archive.org/web/20201023212029/https://tech.labs.oliverwyman.com/blog/2020/08/27/nfrs-considered-harmful/))
