...
Let\'s narrow this to managing dependencies. Managing versioning between modules is a problem that scales quadratically, and is worse than you think given [Hyrum\'s law](https://www.hyrumslaw.com/) that in the limit there is no such thing as a private interface. In the Google case, it\'s their code and they can tackle the problem at the root. Their solution seems to be [\'live at head\'](https://www.youtube.com/watch?v=tISy7EJQPzI). It ideally goes something like this:
...
(Originally [here](http://web.archive.org/web/20201113035100/https://tech.labs.oliverwyman.com/blog/2020/10/02/breaking-changes/))
