...
- Pattern matching everywhere in F#. But patterns have their problems. You really want to name, abstract and parametrize patterns, otherwise you have to break abstraction boundaries to get the convenience. =\> Active patterns. Code ⇔ Data
...
Also, Combined regression and ranking, a paper from Google (D. Sculley). In regression, you\'re trying to guess a number and only distance matters ‐ may do bad job at ordering. But for ranking, you are trying to figure out order. [page](https://www.codemesh.io/codemesh2014/richard-minerich)
...
Ideas for doing AI on the GPU. TL;DR you have to rethink your algorithm choice a bit because it\'s highly parallel and you don\'t want to coordinate. [video](https://vimeo.com/113485431)
...
(Originally [here](http://web.archive.org/web/20161006151917/http://www.lshift.net/blog/2014/11/28/codemesh-2014-day-1/))
