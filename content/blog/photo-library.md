...
aliases = ["blog/photo-library.html"]
...
So I first thought I would be smart and use SIFT to [find transformation-invariant parts of
images](http://docs.opencv.org/3.2.0/dc/dc3/tutorial_py_matcher.html), and then use them as an index somehow, but it
turns out that
