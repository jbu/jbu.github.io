...
- Mounting board that sticks to a window (I used [this](https://thepihut.com/products/zeroview))
- A script (/capture.sh ?)

We will want to access the images in a grid with rows according to day in year, and columns by minute in day, so name
the image thus to make retrieval simpler.
...
than auto exposure perhaps. Anyway, onwards!
